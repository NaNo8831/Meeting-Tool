...
- Defining Objective cards are compact scan summaries with preserved color and task-status counts; objective summary editing, task workflow, and task detail access now open from a click-in workflow detail modal.
