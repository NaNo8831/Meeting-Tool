...
- Objective card polish keeps the shared distribution rules while layering the vertical Defining Objective color menu above wrapped rows, placing Open details beside the task summary, opening newly added Defining Objectives directly into workflow details, and allowing Standard Operating Objective titles to wrap to two lines.
