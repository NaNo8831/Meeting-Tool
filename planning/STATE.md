...
- Defining Objective cards are compact auto-fitting scan summaries with a direct color selector and total task count; objective summary editing, task workflow, and task detail access open from a click-in workflow detail modal.
